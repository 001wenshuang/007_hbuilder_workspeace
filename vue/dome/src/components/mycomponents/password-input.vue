<template>
	...
	<div id="app">
		<div class="password-out" :style="stylesetbgcolor">
...
<script>
	export default {
		...
		props: {
			...
			setbgcolor: {  //这种使用括号的写法 默认才有效
			tyte: String , //设置背景颜色   传递过来是啥颜色 就是啥颜色
			default: "0" }, //默认为 0
		...
		computed : { //通过传值动态控制样式的   显示
			...
			stylesetbgcolor() {
				if(this.setbgcolor == '0') {

					return "background-color: #B9B1B1;";
				} else {

					return "background-color:" + this.setbgcolor;
				}
